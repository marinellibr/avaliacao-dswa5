...
var cursos = [
    { _id: 1, curso: 'Engenharia de Produção', coordenador: 'marinelli.luiz@ifsp.edu.br' },
    { _id: 2, curso: 'Tecnologia em Análise e Desenvolvimento de Sistemas', coordenador: 'marinelli.luiz@ifsp.edu.br' },
    { _id: 3, curso: 'Licenciatura em Letras Português/Inglês', coordenador: 'marinelli.luiz@ifsp.edu.br' },
    { _id: 4, curso: 'Tecnologia em Gestão Pública', coordenador: 'marinelli.luiz@ifsp.edu.br' }
]
